...
- **Màn hình Welcome**: Giới thiệu 4 trang với animation đẹp mắt
- **Dashboard tổng quan**: Vòng tròn pin trực quan, thống kê grid, glassmorphism cards
...
│   ├── Color+Hex.swift            # Shared Color extension
...
| `PROVISIONING_PROFILE_SPECIFIER` | Tên provisioning profile trong Xcode |
